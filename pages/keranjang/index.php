...
try {
    ...
    $queryCheck = "SELECT * FROM keranjang WHERE id_user = :id_user AND id_transaksi = :id_transaksi ORDER BY id_keranjang DESC";
...
//     $statement->execute();
//     $dataKeranjang = $statement->fetch(PDO::FETCH_ASSOC);
//
//     /*
...
//        $stmUser->bindValue(':id_user', $dataKeranjang['id_user']);
//        $stmUser->execute();
//        $resultUser = $stmUser->fetch(PDO::FETCH_ASSOC);
//
//        /*
//         * Defaul User 'Tidak diketahui'
//         */
//
//        $user = [
//            'id_user' => $dataKeranjang['id_user'],
//            'username' => 'Tidak diketahui'
//        ];
//
//        if ($resultUser) {
...
//        $stmBarang->bindValue(":kode_barang", $dataKeranjang['kode_barang']);
//        $stmBarang->execute();
...
//
//        $barang = [
//            'kode_barang' => $dataKeranjang['kode_barang'],
...
//        'user' => $user,
//        'barang' => $barang,
//        'kuantitas' => $dataKeranjang['kuantitas']
//    ];
 ...
 */
/*if (!$dataFinal) {
    $reply['error'] = 'Data dengan ID User: '.$id_user. ' tidak ditemukan !!';
    echo json_encode($reply);
    http_response_code(400);
    exit(0);
}*/
